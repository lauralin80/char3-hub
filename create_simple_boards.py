#!/usr/bin/env python3
"""
Create the 6 boards with basic structure (no custom fields for now)
"""
...
class SimpleBoardCreator:
    """Creates the 6 boards with basic structure"""
    ...
    def create_all_boards(self):
        ...
        print(f"• Custom fields can be added manually in Trello")
